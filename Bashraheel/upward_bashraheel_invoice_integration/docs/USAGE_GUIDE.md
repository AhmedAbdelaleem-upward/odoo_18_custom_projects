...
2.  Go to **Apps**.
3.  Search for **"Bashraheel FastAPI Invoice Integration"** (`upward_bashraheel_fastapi`).
4.  Click **Activate/Install**.
    *   *Note: This will automatically install the core `upward_bashraheel_invoice_integration` module and all required dependencies (FastAPI, JWT Auth, etc.).*
