...
PARAM_KEY_JWT_SECRET = "bashraheel_fastapi.jwt_secret_key"
PARAM_KEY_ACCESS_EXPIRE_MIN = "bashraheel_fastapi.access_token_expire_minutes"
PARAM_KEY_REFRESH_EXPIRE_DAYS = "bashraheel_fastapi.refresh_token_expire_days"
